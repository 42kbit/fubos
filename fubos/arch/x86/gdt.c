...
struct gdt_entry gdt[GDT_NENT] = {
	[GDT_IDX_NULL]  = {0},
	[GDT_IDX_KCODE] = gdt_make_entry(0, 0xfffff, KCODE_FLAGS, GDT_32_ACCESS),
	[GDT_IDX_KDATA] = gdt_make_entry(0, 0xfffff, KDATA_FLAGS, GDT_32_ACCESS),
	[GDT_IDX_UCODE] = gdt_make_entry(0, 0xfffff, UCODE_FLAGS, GDT_32_ACCESS),
	[GDT_IDX_UDATA] = gdt_make_entry(0, 0xfffff, UDATA_FLAGS, GDT_32_ACCESS)
};
